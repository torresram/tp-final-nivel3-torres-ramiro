...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder" runat="server">
    ...
    <asp:UpdatePanel runat="server" ID="updFavoritos" ChildrenAsTriggers="true" UpdateMode="Conditional">
        <ContentTemplate>
            <div class="col">
                <h2 class="h5" runat="server" id="mensajeNoFavs" style="display: none; margin-top: 20px; text-align: center;">No se encontraron favoritos.</h2>
            </div>
            <div class="row">
                            ...
                            <div class="card">
                                <div class="card-body d-flex">
                                    ...
                                    <div style="width: 40px; height: 40px; position: absolute; right: 15px; bottom: 15px;">
                                        <asp:ImageButton ImageUrl='<%#ResolveUrl("~/Images/tacho.png") %>' runat="server" ID="btnQuitarFav" CssClass="btn object-fit-contain" CommandName="eliminarFav" CommandArgument='<%#Eval("Id") %>' Style="border-color: transparent; height: 40px; padding: 0;" />
                                    </div>
                                </div>
                            </div>
                        </div>
